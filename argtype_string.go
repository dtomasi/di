...
func _() {
	...
	_ = x[ArgTypeLogger-4]
	_ = x[ArgTypeService-5]
	_ = x[ArgTypeParam-6]
}

const _ArgType_name = "ArgTypeInterfaceArgTypeContextArgTypeContainerArgTypeParamProviderArgTypeLoggerArgTypeServiceArgTypeParam"

var _ArgType_index = [...]uint8{0, 16, 30, 46, 66, 79, 93, 105}
